...
(function() {
  ...
  <footer style="background:#2E3B28;color:rgba(255,255,255,0.7);padding:60px 80px 0;">
    <div class="spec-footer-grid" style="display:grid;grid-template-columns:1.5fr 1fr 1fr 1fr;gap:40px;margin-bottom:40px;">
      <div>
    ...
    <div style="border-top:1px solid rgba(255,255,255,0.08);padding:20px 0;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
      <p style="font-size:13px;color:rgba(255,255,255,0.5);margin:0;">© 2025 Spec Interior. All rights reserved. Made with ❤️ in India.</p>
  ...
  style.textContent = `
    @media (max-width: 860px) {
      .spec-footer-grid { grid-template-columns: 1fr 1fr !important; gap: 24px !important; }
      footer { padding: 40px 24px 0 !important; }
    }
    @media (max-width: 500px) {
      footer { padding: 32px 16px 0 !important; }
      .spec-footer-grid { grid-template-columns: 1fr 1fr !important; gap: 20px !important; }
    }
  `;
